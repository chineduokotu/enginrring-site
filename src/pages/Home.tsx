...
const heroSlides = [
  {
    ...
    subheadline:
      "Premium electrical and engineering solutions for homes and businesses. Experience the difference of working with certified professionals.",
    ctaText: "Get Started",
  ...
  },
  {
    ...
    subheadline:
      "Harness the power of the sun with our state-of-the-art solar installations. Reduce costs and your carbon footprint.",
  ...
  },
  {
    ...
    subheadline:
      "Protect what matters most with advanced CCTV and security solutions. 24/7 monitoring for complete peace of mind.",
  ...
  },
  {
    ...
    subheadline:
      "Your one-stop shop for premium electrical components, solar equipment, and professional engineering tools.",
    ctaText: "Shop Now",
    ctaLink: "/store",
  },
  {
    ...
    subheadline:
      "Explore our portfolio of completed projects across electrical, solar, and security installations.",
  ...
  },
  {
    ...
    subheadline:
      "Join our professional training programs. Master solar installations, electrical engineering, and smart home automation.",
    ctaText: "Chat on WhatsApp",
    ctaLink:
      "https://wa.me/2349136030440?text=Hello!%20I%20am%20interested%20in%20joining%20the%20Academy%20for%20training.",
    isExternal: true,
  },
  {
    id: 4,
    ...
    subheadline:
      "Transform your living space with intelligent automation. Control your home from anywhere in the world.",
...
const services = [
  ...
  },
  {
    ...
    title: "CCTV & Security",
    description:
      "Advanced surveillance systems with remote monitoring and motion detection technology.",
    image:
  ...
  },
  {
    ...
    title: "Smart Home",
    description:
      "Intelligent automation for lighting, climate, and appliances with seamless integration.",
    image:
  ...
  },
  {
    ...
    description:
      "Robust perimeter security with professional installation and maintenance services.",
    image:
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600 text-lg leading-relaxed">
              From electrical installations to smart home systems, we provide
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg mb-8 leading-relaxed">
                ...
                reputation for delivering exceptional quality and service. Our
                team of certified professionals is committed to exceeding your
                expectations.
              </p>
