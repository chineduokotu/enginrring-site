...
const ProductList: React.FC = () => {
  ...
  const handleSeedProducts = async () => {
    try {
      ...
      setSuccessMessage(
        "Default products loaded! You can now edit them to customize your store.",
      );
      await fetchProducts();
    } catch {
      ...
      {products.length === 0 ? (
        <div className="text-center py-12 sm:py-16 px-4 bg-white rounded-xl shadow-soft">
          ...
          <p className="text-gray-500 mb-6 text-sm sm:text-base">
            Get started by loading default products or adding your own
          </p>
          ...
          <p className="text-gray-400 text-sm mt-4 px-4">
            Load default products to quickly set up your store, then edit each
            one to customize.
          </p>
        </div>
      ) : (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs font-mono text-primary font-bold uppercase">
                      {product.productId}
                    </p>
