    ...
    <div>
      ...
      {showUploadForm && (
        <div className="bg-white rounded-xl shadow-soft p-4 sm:p-6 mb-6">
          <h2 className="text-base sm:text-lg font-semibold text-navy mb-4">
            Upload New Media
          </h2>
            ...
            <div className="flex flex-col sm:flex-row sm:items-start gap-4">
              <div className="flex-1">
                ...
                <p className="mt-1 text-xs sm:text-sm text-gray-500">
                  Supported: Images (JPG, PNG, GIF, WebP) and Videos (MP4, MOV,
                  AVI)
                </p>
              </div>
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div className="p-2.5 sm:p-4">
                ...
                <h3 className="font-medium text-gray-900 mt-1.5 sm:mt-2 line-clamp-1 text-sm sm:text-base">
                  {item.title}
                </h3>
                {item.description && (
